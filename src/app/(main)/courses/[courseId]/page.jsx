...
const CourseDetailsPage = async ({ params }) => {
    ...
    return (
        <div className='bg-[#011e22] flex flex-col justify-center items-center text-zinc-50'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 md:py-10 flex flex-col'>
                ...
                <div className='flex flex-col md:flex-row justify-between items-center gap-x-12'>
                    ...
                    <div className='flex flex-col flex-1 mt-4 md:mt-0 justify-center items-center md:items-start gap-4'>
                        ...
                        <p className='font-semibold text-lg text-center md:text-left'>{course.description}</p>
